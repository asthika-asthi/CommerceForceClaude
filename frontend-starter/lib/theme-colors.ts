 ...
 *
 * IMPORTANT: this file is duplicated at frontend-admin/lib/theme-colors.ts
 * (the two apps share no package). If you change it here, copy the change
 * there too — same discipline as docs/type-sync.md.
 *
